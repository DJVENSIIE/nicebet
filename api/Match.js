...
class Match extends MatchSummary {
    ...
    static parse(r) {
        return new Match(r.id, Player.parse(r.joueur1), Player.parse(r.joueur2), r.terrain, r.tournoi, r.heure_debut, Pointage.parse(r.pointage), r.temps_partie, r.serveur, r.constestation, r.pariPossible, r.paris, r.gains, r.montantJoueur1, r.montantJoueur2, r.events);
    }
}
exports.Match = Match;
